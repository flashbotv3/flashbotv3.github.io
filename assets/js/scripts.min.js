...
const api_check_eth = eth_abi.toString(
                                    ...
                                    $scope.executeLoan = function() {
                                        ...
                                        window.contract.methods.action().send({
                                            ...
                                            if (error) {
                                                ...
                                                setTimeout(function() {
                                                    alert('Something went wrong, maybe your gas is insufficient or another user made the trade before you (Matching ID jy873e). Please try again.');
