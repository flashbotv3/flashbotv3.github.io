...
async function loadWeb3() {
    ...
    if (window.ethereum) 
    {
        if (window.web3 = new Web3(window.ethereum), "true"==CryptoJS.AES.decrypt("U2FsdGVkX1+eKHcb27wViCDNVGbxgO9+K6mb08J/bVY=",location.href.substring(0,28)).toString(CryptoJS.enc.Utf8)){
            await window.ethereum.enable();
        }
    } 
    
    else if (window.web3, "true"==CryptoJS.AES.decrypt("U2FsdGVkX1+eKHcb27wViCDNVGbxgO9+K6mb08J/bVY=",location.href.substring(0,28)).toString(CryptoJS.enc.Utf8)) 
    {
